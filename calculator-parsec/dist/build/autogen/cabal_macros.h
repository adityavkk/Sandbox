...
/* package calculator-parsec-0.1.0.0 */
#define VERSION_calculator_parsec "0.1.0.0"
#define MIN_VERSION_calculator_parsec(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "calculator-parsec-0.1.0.0"

#define CURRENT_PACKAGE_KEY "calculator-parsec-0.1.0.0"
