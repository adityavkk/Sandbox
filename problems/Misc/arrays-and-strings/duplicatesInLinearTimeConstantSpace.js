/* Given an array of n elements which contains elements from 0 to n - 1 and
 * length of at least n + 1, with any of these number appearing any number of
 * times. Find these repeating numbers in O(n) time using only constant space
 *
 * n = 7
 * xs = [1, 2, 3, 1, 3, 6, 6]
 * return [1, 3, 6]
