 ...
 * with Immutable insert and delete
 *
 * Delete algorithm from Matt Might's great post on delete in functional RB trees
 * */
...
const rd = 0,
  ...
  nb = -1,
  log = console.log,
  printTree = t => { log(JSON.stringify(t, null, 4)); return t; };
